...
suite "Sync committee pool":
  ...
  test "Aggregating votes":
    ...
    block:
      ...
      let
        success = pool.produceContribution(bid1.slot, bid1, subcommittee1, contribution)
    ...
    block:
      ...
      let
        success = pool.produceContribution(bid1.slot, bid1, subcommittee2, contribution)
    ...
    block:
      ...
      let
        success = pool.produceContribution(bid2.slot, bid2, subcommittee2, contribution)
    ...
    block:
      ...
      let
        success = pool.produceContribution(bid3.slot, bid3, subcommittee2, contribution)

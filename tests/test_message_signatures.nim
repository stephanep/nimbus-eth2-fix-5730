    ...
    check:
      ...
      verify_deposit_signature(
        ...
        DepositData(
          pubkey: pubkey0,
          signature:
            get_deposit_signature(preset, DepositData(pubkey: pubkey0), privkey0).toValidatorSig,
        ),
      )
      ...
      not verify_deposit_signature(
        ...
        DepositData(
          pubkey: pubkey0,
          signature:
            get_deposit_signature(preset, DepositData(pubkey: pubkey0), privkey1).toValidatorSig,
        ),
      )

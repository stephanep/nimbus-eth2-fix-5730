...
suite "Slashing Protection DB" & preset():
  ...
  test "SP for block proposal - linear append":
    ...
    check:
      db.registerBlock(ValidatorIndex(100), fakeValidator(100), Slot 10, fakeRoot(100)).isOk()

      db.registerBlock(ValidatorIndex(111), fakeValidator(111), Slot 15, fakeRoot(111)).isOk()
  ...
  test "SP for block proposal - backtracking append":
    ...
    check:
      ...
      db.registerBlock(ValidatorIndex(100), fakeValidator(100), Slot 10, fakeRoot(10)).isOk()

      db.registerBlock(ValidatorIndex(100), fakeValidator(100), Slot 20, fakeRoot(20)).isOk()
    for i in 0..<30:
      let
        status =
          db.checkSlashableBlockProposal(
    ...
    check:
      db.registerBlock(ValidatorIndex(100), fakeValidator(100), Slot 15, fakeRoot(15)).isOk()
    for i in 0..<30:
    ...
    check:
      db.registerBlock(ValidatorIndex(100), fakeValidator(100), Slot 12, fakeRoot(12)).isOk()

      db.registerBlock(ValidatorIndex(100), fakeValidator(100), Slot 17, fakeRoot(17)).isOk()
    for i in 0..<30:
    ...
    check:
      db.registerBlock(ValidatorIndex(100), fakeValidator(100), Slot 29, fakeRoot(29)).isOk()
  ...
  test "Pruning blocks works":
    block:
      ...
      db.registerBlock(ValidatorIndex(100), fakeValidator(100), Slot 10, fakeRoot(10)).expect(
        "registered block"
      )

      db.registerBlock(ValidatorIndex(100), fakeValidator(100), Slot 1000, fakeRoot(20)).expect(
        "registered block"
      )

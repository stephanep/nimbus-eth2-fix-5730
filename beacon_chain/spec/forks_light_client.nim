...
template kind*(
    x:
      typedesc[ # `SomeLightClientObject` doesn't work here (Nim 1.6)
      ...
      if x.kind == LightClientDataFork.Altair:
        x =
          ForkedLightClientHeader(
            ...
            capellaData:
              upgrade_lc_header_to_capella(x.forky(LightClientDataFork.Altair)),
          )
      ...
      if x.kind == LightClientDataFork.Capella:
        x =
          ForkedLightClientBootstrap(
            kind: LightClientDataFork.Deneb,
            denebData:
              upgrade_lc_bootstrap_to_deneb(x.forky(LightClientDataFork.Capella)),
          )
      ...
      if x.kind == LightClientDataFork.Altair:
        x =
          ForkedLightClientUpdate(
            kind: LightClientDataFork.Capella,
            capellaData:
              upgrade_lc_update_to_capella(x.forky(LightClientDataFork.Altair)),
          )
      ...
      if x.kind == LightClientDataFork.Altair:
        x =
          ForkedLightClientStore(
            kind: LightClientDataFork.Capella,
            capellaData:
              upgrade_lc_store_to_capella(x.forky(LightClientDataFork.Altair)),
          )

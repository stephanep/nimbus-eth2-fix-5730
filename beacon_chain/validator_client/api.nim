          ...
          if apiResponse.isErr():
            ...
            of 200:
              let
                res =
                  decodeBytes(
                    GetProposerDutiesResponse, response.data, response.contentType
                  )
              if res.isErr():
          ...
          if apiResponse.isErr():
            ...
            of 200:
              let
                res =
                  decodeBytes(
                    GetAttesterDutiesResponse, response.data, response.contentType
                  )
              if res.isErr():
                handleUnexpectedData()
  ...
  of ApiStrategyKind.Priority:
    vc.firstSuccessSequential(
      ...
      if apiResponse.isErr():
        ...
        of 200:
          let
            res = decodeBytes(GetBlockRootResponse, response.data, response.contentType)
          if res.isErr():
            handleUnexpectedData()
            false
          else:
          ...
          if apiResponse.isErr():
            ...
            of 200:
              let
                res =
                  decodeBytes(
                    GetStateValidatorsResponse, response.data, response.contentType
                  )
              if res.isErr():
                handleUnexpectedData()
